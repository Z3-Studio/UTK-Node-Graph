    ...
    public class NodeVariablesPanel : VisualElement
    {
        ...
        private void CreateReferenceVariables(GraphData graphData, VisualElement root)
        {
            ...
            if (graphData.ReferenceVariables != null)
            {
                ...
                VariableList referenceVariables = new VariableList("Reference Variables".ToBold(), graphData.ReferenceVariables, graphData.ReferenceVariables.DeclaredVariables, true, tooltip);
